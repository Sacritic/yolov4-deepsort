...
def main(_argv):
    ...
    while True:
        ...
        if FLAGS.count:
            ...
            cv2.putText(frame, "Car #: {0:02d}, Bus #: {1:02d}, Truck #: {2:02d}".format(count_classes[0],count_classes[1],count_classes[2]), (1050, 35), cv2.FONT_HERSHEY_COMPLEX_SMALL, 2, (0, 255, 0), 2)
